"""Machine-readable covariate provenance for Workflow 1."""
...
def covariate_provenance(project_id, crs, computational_grid_m, start_date, end_date):
    ...
    grid_m = float(computational_grid_m)
    grid_label = f"{grid_m:g} m"
    grid_note = (
    ...
    return {
        ...
        "interpretation_warning": (
            ...
            f"{grid_label} source detail. Interpret every covariate at its declared "
            "native/effective input scale; resampling only aligns the grid."
        ),
    }
