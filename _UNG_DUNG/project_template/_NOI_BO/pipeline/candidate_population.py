...
def sample_valid_candidates(
    *, sources, soil_src, core_mask, transform, max_candidates, rng
    ...
    sorted set of uniformly drawn population ranks back to cells. Soil codes are
    nominal: every positive code is retained except the raster's declared nodata.
    """
    ...
    metadata = {
        ...
        "soil_factor_validity_rule": "all finite codes >=1 except raster nodata",
