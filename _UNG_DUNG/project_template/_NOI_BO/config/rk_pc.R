...
RASTER_MANIFEST_FILE <- "projects/{{PROJECT_ID}}/_NOI_BO/config/raster_manifest.csv"
OUTPUT_ROOT <- "projects/{{PROJECT_ID}}/_NOI_BO/work/models/PC_ONLY"
OUTPUT_NAME_PREFIX <- "{{PROJECT_ID}}_PC_"
