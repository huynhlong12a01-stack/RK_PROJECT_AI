...
point_dir <- file.path(root, "staging", "sample_actual")
raster_dir <- file.path(root, "staging", "covariates")
...
status <- system2(
  Sys.which("Rscript"), "_UNG_DUNG/engine/scripts/main.R", stdout = log_file, stderr = log_file)
