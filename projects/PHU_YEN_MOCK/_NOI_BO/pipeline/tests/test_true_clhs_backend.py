...
def main():
    ...
    require(metadata["multi_start_selection"]["minimum_spacing_target_met"] is True, "Spacing target was not met.")
    require(metadata["multi_start_selection"]["selected_spacing_violation_pairs"] == 0, "Spacing violations were accepted.")
