...
RASTER_MANIFEST_FILE <- "projects/PHU_YEN_MOCK/_NOI_BO/config/raster_manifest_with_soil.csv"
OUTPUT_ROOT <- "projects/PHU_YEN_MOCK/_NOI_BO/work/models/PC_PLUS_SOIL"
OUTPUT_NAME_PREFIX <- "PHU_YEN_MOCK_PC_SOIL_"
