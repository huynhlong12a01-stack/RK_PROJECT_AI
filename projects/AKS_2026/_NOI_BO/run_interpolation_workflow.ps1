...
if ($hasSoil) {
  ...
  RunChecked $rscript @("_UNG_DUNG\engine\scripts\validate_raster_schema.R", "--config", "projects\AKS_2026\_NOI_BO\config\full_pc_soil.R", "--point", "projects\AKS_2026\_NOI_BO\work\interpolation\sample_actual_clean.csv", "--output", "projects\AKS_2026\_NOI_BO\work\interpolation\qa\raster_schema_current.json")
} else {
  Write-Host "[INFO] Khong co Soil Type; chi chay mo hinh PC." -ForegroundColor Yellow
  RunChecked $rscript @("_UNG_DUNG\engine\scripts\validate_raster_schema.R", "--config", "projects\AKS_2026\_NOI_BO\config\full_pc.R", "--point", "projects\AKS_2026\_NOI_BO\work\interpolation\sample_actual_clean.csv", "--output", "projects\AKS_2026\_NOI_BO\work\interpolation\qa\raster_schema_current.json")
}
