...
RASTER_MANIFEST_FILE <- "projects/AKS_2026/_NOI_BO/config/raster_manifest_with_soil.csv"
OUTPUT_ROOT <- "projects/AKS_2026/_NOI_BO/work/models/PC_PLUS_SOIL"
OUTPUT_NAME_PREFIX <- "AKS_2026_PC_SOIL_"
